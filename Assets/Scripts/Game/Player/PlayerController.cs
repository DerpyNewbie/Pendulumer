...
namespace Game
{
    public class PlayerController : MonoBehaviour
    {
        ...
        [Header("Wall JumpAction")]
        [SerializeField] private Vector2 wallJumpVelocity = new Vector2(2, 5);
        ...
        public event Action<EventContext> OnLedgeGrab;
        ...
        private void CheckWall()
        {
            ...
            var lastLedgeGrabbing = _playerState.LedgeGrabbing;
            ...
            if (lastLedgeGrabbing != _playerState.LedgeGrabbing)
            {
                OnLedgeGrab?.Invoke(_playerState.IsGrabbingLedge ? EventContext.Begin : EventContext.End);
            }
        }
        ...
        private void HandleLedgeGrabbing()
        {
            var movement = _moveAction.ReadValue<Vector2>();
        ...
        private void OnCrouchInputPerformed(InputAction.CallbackContext ctx)
        {
            ...
            _playerState.IsAutoSliding = false;
